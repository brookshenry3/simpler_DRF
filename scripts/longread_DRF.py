...
def main ():
    ...
    df = df[['chrom', 'pos', 'reads', 'phred_av']] #reordering the columns and dropping the ones that I don't need
    ...
    #df = df[df['map_av'] <= args.map]
    #df = df[df['phred_av'] <= args.phred]
...
These are the full stats from a COLO829 chr22 run using a 1mb window and 40 cores

len chunks 51
Chunking time: 58.49202036857605
Time to aggregate data: 404.78424620628357
Time to filter: 581.9802191257477
Saving raw data...
Time to save raw data: 54.14289665222168
Classifying positions...
Time to classify positions: 10.85614013671875
Joining adjacent rows and creating BED file...
Time to join rows & save file: 651.7284352779388
Generating summary statistics...
Time to generate summary statistics: 0.003534078598022461
'''
